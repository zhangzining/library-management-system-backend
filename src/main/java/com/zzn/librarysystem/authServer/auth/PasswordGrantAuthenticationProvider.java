...
public class PasswordGrantAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!registeredClient.getAuthorizationGrantTypes().contains(authorizationGrantType)) {
            throw new OAuth2AuthenticationException("未知认证方式");
        }
        ...
        // 初始化 DefaultOAuth2TokenContext builder
        ...
        // 初始化 OAuth2Authorization builder
        ...
        if (generatedAccessToken == null) {
            throw new OAuth2AuthenticationException("生成 accessToken 失败");
        }
        ...
        if (registeredClient.getAuthorizationGrantTypes().contains(AuthorizationGrantType.REFRESH_TOKEN) &&
            ...
            if (!(generatedRefreshToken instanceof OAuth2RefreshToken)) {
                throw new OAuth2AuthenticationException("生成 refreshToken 失败");
            }
